...
export default class AccordionEditing extends Plugin {
  ...
  _defineSchema() {
    ...
    schema.addChildCheck((context, childDefinition) => {
      if (
        context.endsWith("accordionPanel") &&
  ...
  _defineConverters() {
    ...
    conversion.for("dataDowncast").elementToElement({
      ...
      view: (modelElement, { writer: viewWriter }) => {
        const div = viewWriter.createContainerElement("div", {
          class:
            "accordion" + (modelElement.getAttribute("isOpen") ? " open" : ""),
        });
    ...
    conversion.for("editingDowncast").elementToElement({
      ...
      view: (modelElement, { writer }) => {
        ...
        writer.setAttribute(
          "class",
          modelElement.getAttribute("isOpen")
            ? "open accordion-plugin"
            : "accordion-plugin",
          div
        );
    ...
    editor.editing.view.document.on(
      ...
      (evt, data) => {
        ...
        if (accordionButton) {
          ...
          const accordionModelElement =
            editor.editing.mapper.toModelElement(accordionViewElement);
